import { ExternalLink, Github, GithubIcon, ArrowRight } from "lucide-react";
const projects = [
{
  id: 1,
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
                {" "}
                 ...
                 <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    Here are my recent projects. Each project was carefully
                           ...
                           <p className="text-muted-foreground text-sm mb-4">
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex space-x-3">
                                    <a
                                     href={project.githubUrl} target="_blank" className="text-foreground/80 hover:text-primary transition-colors duration-300" >
